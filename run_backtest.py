...
if __name__ == '__main__':
    ...
    triple_screen_daily_strategy = TripleScreenDaily(
        data_store=backtest_instance.data_store,
        strategy_params={
        ...
        broker=backtest_instance.broker
    )
    ...
    # 전환 14.91
    #backtest_instance.set_strategies(daily_strategy=triple_screen_daily_strategy, minute_strategy=rsi_minute_strategy)
    # 전환 57.51
