...
class DataManager:
    ...
    def get_realtime_price(self, stock_code: str) -> Optional[float]:
        return self.api_client.get_current_price(stock_code)

    def get_realtime_minute_data(self, stock_code: str, count: int = 1) -> Optional[pd.DataFrame]:
        return self.api_client.get_current_minute_data(stock_code, count)
