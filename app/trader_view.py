...
class TraderView(QWidget):
    def __init__(self):
        super().__init__()
        self.run_list_model = TraderModel()
        self.performance_model = TraderModel()
        self.traded_stocks_model = TraderModel()
    ...
    def init_ui(self):
        ...
        # Left Bottom: Trader Performance List (테이블만 남김)
