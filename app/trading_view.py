...
# 통합된 TradingModel 임포트
from app.trading_model import TradingModel
...
class TradingView(QWidget):
    def __init__(self, app_manager: AppManager):
        super().__init__()
        self.run_list_model = TradingModel(app_manager)
        self.performance_model = TradingModel(app_manager)
        self.traded_stocks_model = TradingModel(app_manager)
    ...
    def init_ui(self):
        ...
        # Left Bottom: Trading Performance List (테이블만 남김)
